    ...
    <div className="min-h-screen flex bg-[#FCFAF7] text-[#261F1A] font-sans overflow-hidden relative selection:bg-[#DE9E26]/20">
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-[#261F1A] p-16 flex-col justify-between relative overflow-hidden border-r border-[#261F1A]">
        ...
        <div className="relative z-10 max-w-sm">
          <span className="text-[#DE9E26] text-[10px] font-bold uppercase tracking-widest block mb-4">// System Node 02</span>
          <h2 className="text-4xl font-serif font-light text-white leading-tight mb-6">
            Initialize an operational compliance node.
          </h2>
          <p className="text-neutral-400 text-xs font-medium leading-relaxed">
            Create an analytical structural trace. Sync compliance states, compile audit metrics, and isolate legal dependencies automatically.
          </p>
        </div>
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-8 md:p-16 relative">
        ...
        >
          ...
          <div className="mb-10">
            <h3 className="text-3xl font-serif font-normal tracking-tight text-[#261F1A] mb-3">Initialize Account</h3>
            <p className="text-xs text-[#261F1A]/60 font-medium">Provision your dedicated organizational pipeline using Google configuration.</p>
          </div>
          ...
          <div className="space-y-6">
            <motion.button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-[#DE9E26] text-[#261F1A] font-bold text-xs uppercase tracking-widest py-4.5 rounded-xl shadow-md shadow-[#DE9E26]/10 hover:bg-[#C98D1E] hover:text-white transition-all border border-transparent"
            >
          ...
          <div className="mt-12 pt-6 border-t border-[#EBE5DF] text-center text-xs font-bold text-[#261F1A]/50 uppercase tracking-widest">
            Already verified? <Link href="/login" className="text-[#261F1A] underline ml-1 hover:text-[#DE9E26] transition-colors">Console console</Link>
          </div>
        </motion.div>
      </div>
    </div>
